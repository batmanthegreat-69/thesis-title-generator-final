...
// Vercel's filesystem is read-only except /tmp, so the model cache has to go
// there when running on Vercel. Locally (npm start), leave the library's
// default cache location alone. VERCEL is a env var Vercel sets automatically.
